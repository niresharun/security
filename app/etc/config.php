...
return [
    ...
    'modules' => [
        ...
        'Perficient_AvaTax' => 1,
        'Perficient_Base' => 1,
        'Perficient_BlueshipShipping' => 1,
        'Perficient_Catalog' => 1,
        'Perficient_CatalogPermissions' => 1,
        'Perficient_Ccpa' => 1,
        'Perficient_Company' => 1,
        'Perficient_Checkout' => 1,
        'Perficient_Core' => 1,
        'Perficient_CronScheduler' => 1,
        'Perficient_Csp' => 1,
        'Perficient_Customer' => 1,
        'Perficient_Customform' => 1,
        'Perficient_Gdpr' => 1,
        'Perficient_GdprCookie' => 1,
        'Perficient_GoogleTagManager' => 1,
        'Perficient_LeadTime' => 1,
        'Perficient_MailChimp' => 1,
        'Perficient_Productimize' => 1,
        'Perficient_MyDisplayInformation' => 1,
        'Perficient_OfflinePayments' => 1,
        'Perficient_Order' => 1,
        'Perficient_ParadoxLabsAuthnetcim' => 1,
        'Perficient_ParadoxLabsTokenBase' => 1,
        'Perficient_Payment' => 1,
        'Perficient_PaymentMethodAdditionalData' => 1,
        'Perficient_Persistent' => 1,
        'Perficient_MyCatalog' => 1,
        'Perficient_PriceMultiplier' => 1,
        'Perficient_QuickShip' => 1,
        'Perficient_Rabbitmq' => 1,
        'Perficient_Reports' => 1,
        'Perficient_RequisitionList' => 1,
        'Perficient_RolesPermission' => 1,
        'Perficient_Sales' => 1,
        'Perficient_Search' => 1,
        'Perficient_Seo' => 1,
        'Perficient_Shipping' => 1,
        'Perficient_Sitemap' => 1,
        'Perficient_SocialShare' => 1,
        'Perficient_Theme' => 1,
        'Perficient_ViewInRoom' => 1,
        'Perficient_Wishlist' => 1,
        'Perficient_WishlistSet' => 1,
        'Perficient_Zsetup' => 1,
        ...
        'Wendover_Checkout' => 1,
        'Wendover_Company' => 1,
        'Wendover_ConfigurableProduct' => 1,
        'Wendover_Customer' => 1,
        'Wendover_FedexShipping' => 1,
        'Wendover_FindYourRep' => 1,
        'Wendover_FreightEstimator' => 1,
        'Wendover_LoginAsCustomerAssistance' => 1,
        'Wendover_MegaMenu' => 1,
        'Wendover_MyCatalog' => 1,
        'Wendover_PriceMultiplier' => 1,
        'Wendover_TearSheet' => 1,
        'Wendover_Theme' => 1
    ]
];

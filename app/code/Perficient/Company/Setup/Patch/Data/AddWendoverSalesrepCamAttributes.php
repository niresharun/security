 ...
 */
class AddWendoverSalesrepCamAttributes implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        foreach ($attributesInfo as $attributeCode => $attributeParams) {
            $attributeCheck = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, $attributeCode);
            if(!$attributeCheck) {

 ...
 */
class UpdateTypeOfProjectsAttributes implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute('customer', 'type_of_projects');
        $data = [];
        $attribute->setData('used_in_forms', $data);
        $attribute->save();
    }

<?php
/**
 * Send Magento information to SysPro
 * @category: Magento
 ...
 */
class MagentoToErp extends AbstractModel
{
    /**
     * @var $isDataSubmitted
     */
     ...
     */
    public function sendDataFromMagentoToERP($topic, $message)
    {
        try {

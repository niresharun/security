...
define(
    [
        'ko',
        'jquery',
        'Perficient_PaymentMethodAdditionalData/js/view/payment/method-renderer/cc',
        'mage/translate'
    ],
    function (ko, $, Component) {
        ...
        return Component.extend({
            defaults: {
                template: 'Perficient_PaymentMethodAdditionalData/payment/cc',
...
// Change certain error responses to be more useful.
                    ...
                    $.extend(
                        ...
                        paymentData,
                        {
                            'additional_data': {
                                ...
                                'bankowner': $('#authnetcim_bankowner').val()
                            }
                        }
                    )
                }
            ...
            getPaymentMethodFeeMessage: function () {
                ...
                if (paymentFeeMessage) {
                    var authnetcimFeeMessage = paymentFeeMessage.authnetcim;
                    if (authnetcimFeeMessage) {
                        return authnetcimFeeMessage;
                    }
                }

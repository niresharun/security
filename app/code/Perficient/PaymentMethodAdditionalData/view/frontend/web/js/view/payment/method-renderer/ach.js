...
define(
    ...
    function (ko, $, _, Component, $t, placeOrderAction, additionalValidators, alert, quote) {
        ...
        return Component.extend({
            defaults: {
                template: 'Perficient_PaymentMethodAdditionalData/payment/ach',
                isFormShown: true,
            ...
            getData: function () {
                return {
                    ...
                    additional_data: {
                        ...
                        'bankowner': $('#authnetcim_ach_bankowner').val(),
                        'save': this.save()
                    }
                };
            },
            ...
            getPaymentMethodFeeMessage: function () {
                ...
                if (paymentFeeMessage) {
                    var achFeeMessage = paymentFeeMessage.authnetcim_ach;
                    if (achFeeMessage) {
                        return achFeeMessage;
                    }
                }

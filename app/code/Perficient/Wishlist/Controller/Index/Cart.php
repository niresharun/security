...
use Magento\Wishlist\Controller\Index\Cart as ParentCart;
...
class Cart extends ParentCart
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $wishlistProvider, $quantityProcessor, $itemFactory, $cart, $optionFactory,
            $productHelper, $escaper, $helper, $cartHelper, $formKeyValidator, $cookieManager, $cookieMetadataFactory);
    }

<?php
/**
 * This file is used for bulk image upload cron.
 *
 * @category: Magento
...
namespace Perficient\Catalog\Model\Cron\Backend;
...
/**
 * Class Cron
 * @package Perficient\Catalog\Model\Cron\Backend
 */
class Cron extends Value
{
    ...
    const XML_PATH_CRON_ENABLED = 'groups/cron_setup/fields/enabled/value';
    const XML_PATH_CRON_TIME = 'groups/cron_setup/fields/time/value';
    const XML_PATH_CRON_WEEKDAY = 'groups/cron_setup/fields/week_day/value';
    const XML_PATH_CRON_DAY_OF_MONTH = 'groups/cron_setup/fields/month_day/value';
    const XML_PATH_CRON_ENDTIME = 'groups/cron_setup/fields/endtime/value';
    const XML_PATH_CRON_FREQUENCY = 'groups/cron_setup/fields/bulk_upload/value';
     ...
     * @return int|string
     */
    public function minuteExpression($time, $endTime = null, $minuteExp = null)
    {
        if ($minuteExp === null) {
            $minuteExpression = '*';
        } else {
     ...
     * @return int|string
     */
    public function hourExpression($time, $endTime)
    {
        $hours = 0;
        $endTimeHour = 0;
    ...
    {
        return sprintf($path, $this->prefix, $this->suffix, $this->type);
    }
    ...
    {
        return sprintf($path, $this->cronGroup, $this->type, $this->prefix, $this->suffix);
    }
}

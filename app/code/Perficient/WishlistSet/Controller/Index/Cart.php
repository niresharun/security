<?php
/**
 * Overide wishlist add cart controller
 * @category: Magento
...
namespace Perficient\WishlistSet\Controller\Index;
            ...
            if (!$this->cart->getQuote()->getHasError()) {
                if (!empty($relatedProduct)) {
                    $details = [
                        ...
                        'relatedIds' => $relatedProduct
                    ];
                    $this->customerSession->setCartItemInfo($details);
                    ...
                    $this->customerSession->unsCartItemInfo();
                    $message = __(

...
define([
    ...
    $.widget('mage.AddFotoramaVideoEvents', {
        ...
        _createVideoData: function (inputData, isJSON) {
            ...
            for (i = 0; i < inputData.length; i++) {
                ...
                if (tmpInputData.videoUrl && tmpInputData.videoUrl !== null) {
                    ...
                    let videoUrl = tmpInputData.videoUrl;
		...
		_autoPlayTrigger: function () {
            // triggering video touch event on page load
           // if (this.options.videoPlayerConfiguration.autoplay) {
                jQuery(".fotorama__stage__shaft").trigger('touchstart');
            //}
       ...
       /* _attachFotoramaEvents: function () {
        ...
        _attachFotoramaEvents: function () {
            ...
            jQuery(".fotorama__stage__shaft").on("mousedown mouseup keydown keyup touchstart touchend", function () {
                $(document)
                    ...
                    .each(function () {
                        if (
                            ...
                            jQuery(this).removeClass("fotorama__arr--hidden");
                        } else {
                            let videoElement = window.plyr;
                            if (videoElement) {
                                videoElement.pause();
                            }

                            videoElement = window.plyrVimeo;
        ...
        autoPlayVideo() {
            var self = this;
            var videoPlayerConfiguration = self.options;
            var autoplay = true;//videoPlayerConfiguration.videoPlayerConfiguration.autoplay;
            var stageFrame = this.fotoramaItem.data("fotorama").activeFrame.$stageFrame[0];
            var productVideoDiv = $(stageFrame).find('.product-video');
            
            if(productVideoDiv.length ==1 && autoplay){                
                setTimeout(
                    $.proxy(function () {
                        this.fotoramaItem
                            .data("fotorama")

...
define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            // Data Layer Event for Search Suggestion
            $('body').on('amsearch.popup.contentUpdated',function() {
                $('.amsearch-product-list a ').addClass('search-suggestion');
            });
            $(document).ready(function () {
                $('body').on('click', '.amsearch-product-list a', function() {
                    dataLayer.push({
        ...
        onEnter: function (UiClass, event) {
            if (event.keyCode === 13) {
                if ($('.amsearch-input').val().length >= 3) {
